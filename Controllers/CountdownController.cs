...
namespace FerieCountdown.Controllers
{
    public class CountdownController : Controller
    {
        ...
        public IActionResult Newyear() 
        {
            ...
            bg.Html = "<div class=\"pyro\" style=\"display: none; height: 100vh; top: 0; position: fixed; left: 0; width: 100vw;\" id=\"fireworks\"><div class=\"before\"></div><div class=\"after\"></div></div>";
